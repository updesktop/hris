...
function showMap(vmode,usercode){   
  ...
  var dtl2='';
  dtl=
    '<div id="div_showmap" data-vmode='+vmode+' data-p1="'+p1+'" data-p2='+p2+' data-usercode="'+usercode+'" data-zoom=0 style="width:100%;height:100%;text-align:left;padding:0px;border:1px solid black;background-color:lightgray;">'+
      '<div id="theMap" style="position:relative;width:100%;height:'+(H_BODY-(50+3))+'px;border:0px solid red;background-color:none;">'+
        ...
        '</div>'+
      '</div>'+
      '<div id="div_foot_showmap" style="width:100%;height:50px;padding:5px;background:'+JBE_CLOR+';"></div>';
    '</div>';
   if(vmode==0){   
   dtl2=      
    ...
    '</div>';
      ...
      '<div style="width:100%;height:100%;background:none;">'+
        ...
        '<div onclick="map.remove();fm_admin();" style="float:right;width:18%;height:100%;color:'+JBE_TXCLOR1+';background:none;">'+                  
    ...
    JBE_OPEN_VIEW2(dtl,'Client Map','close_showmap');
    //dispMenu(false,dtl2);  
    dispMenu('div_foot_showmap',dtl2);
    map = L.map( 'theMap', {
